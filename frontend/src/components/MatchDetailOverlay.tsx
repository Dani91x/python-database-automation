                ...
                <>
                    ...
                    >
                        ...
                        <div className="bg-brand-orange px-6 py-1 flex items-center justify-between text-[10px] font-black uppercase tracking-[0.2em] text-black">
                            ...
                            <div className="hidden md:block">Session Token: {Math.random().toString(36).substring(7).toUpperCase()}</div>
                        </div>
                                ...
                                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
                                    <div className="space-y-6">
                                        <div className="flex items-center gap-4 mb-4">
                                            ...
                                            <span className="text-[10px] font-black uppercase tracking-[0.3em] text-gray-500">Home Core Profile</span>
                                            <div className="h-px flex-1 bg-white/5" />
                                        </div>
                                    ...
                                    <div className="space-y-6">
                                        <div className="flex items-center gap-4 mb-4">
                                            <div className="h-px flex-1 bg-white/5" />
                                            <span className="text-[10px] font-black uppercase tracking-[0.3em] text-gray-500">Away Core Profile</span>
                                            <div className="h-px flex-1 bg-white/5" />
                                        </div>
                            ...
                            <div className="container mx-auto px-4 mt-12">
                                <div className="p-8 bg-white/5 rounded-[2rem] border border-white/10 flex flex-col md:flex-row gap-6 items-center">
                                    ...
                                    <p className="text-xs font-bold text-gray-500 uppercase tracking-widest leading-loose text-center md:text-left">
                                        Neural Analysis Disclaimer: This report is generated by our proprietary Sport Investing Algorithm.
                                        Past performance is not indicative of future results. Statistical variance of +/- 4% should be expected.
                                    </p>
                                </div>
                            </div>
                        </div>
