    ...
    return (
        <Card className="glass-card p-6">
            <div className="flex items-center gap-2 mb-4 text-muted-foreground">
                ...
                <h4 className="text-xs font-rajdhani font-bold uppercase tracking-widest">Riepilogo Partite</h4>
            </div>
                ...
                <table className="w-full text-sm">
                    <thead>
                        <tr className="text-[10px] uppercase tracking-widest text-muted-foreground border-b border-white/5">
                            ...
                            <th className="text-center py-2 px-2 font-bold text-white">Totale</th>
                        </tr>
                    </thead>
                    <tbody>
                        {rows.map((row) => (
                            <tr key={row.label} className="border-b border-white/5 hover:bg-white/5 transition-colors">
                                ...
                                <td className="py-2 px-2 text-center font-mono font-bold text-white">{row.data.total}</td>
                            </tr>
                        ))}
                    </tbody>
                </table>
