...
const STRATEGY_FIELDS: Num[] = [
    ...
    { key: 'tennis.favSuperMax', label: 'TENNIS · super favorito: quota pre-partita del favorito sotto', step: 0.01, min: 0, hint: 'utente 25/09: «se pre-match il favorito è < 1,20 è un super favorito e l\'altro uno sfavorito estremo» → non si punta lo sfavorito estremo. Se la quota pre-partita manca il controllo non blocca. 0 = spento' },
