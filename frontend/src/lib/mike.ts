...
export const MIKE_PARAM_FIELDS: readonly MikeParamField[] = [
    ...
    { key: 'ht_loss_goals_min', label: 'HT: gol min', kind: 'number', step: 1, min: 0, max: 8, hint: '3 = con due gol non si chiude in perdita: ne servono altri due per perdere l’Under 3.5', group: 'uscite' },
