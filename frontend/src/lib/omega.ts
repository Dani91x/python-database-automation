...
export const OMEGA_PARAM_GROUPS: ParamGroup[] = [
    ...
    },
    {
        ...
        fields: [
            ...
            { key: 'lambda_quote_prima', label: 'Lambda dalle quote 1X2 pre-KO PRIMA della fixture (O1)', type: 'boolean', hint: 'ACCESO di default (misura 25/09: migliora); spento = catena di sempre (fixture prima)' },
    ...
    },
    {
        ...
        fields: [
            ...
            { key: 'model_red_cards', label: 'v3: cartellini rossi nel modello (O5)', type: 'boolean', hint: 'intensita residua per lato moltiplicata per i coefficienti GLOBALI dei rossi (mai per lega), in ingresso e in uscita; ACCESO di default (misura 25/09: migliora); spento = modello di sempre (rossi ignorati)' },
