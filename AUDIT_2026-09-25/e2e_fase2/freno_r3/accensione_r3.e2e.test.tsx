...
const FOTO = resolve(OUT, 'accensione_r3');
...
describe('FASE 2 — RIAVVIO 3 — accensione in paper', () => {
    ...
    it('A0 prerequisito: tutto fermo/paper, order_mode paper', async () => {
        appendFileSync(ORA, `# --- RIAVVIO 3 (app con i fix delle due sessioni) --- intestazione scritta ${new Date().toISOString()}
`, 'utf8');
