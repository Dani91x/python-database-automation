...
describe('FASE 2 — Z13.4 freno', () => {
    ...
    it('F1 tira il freno (un clic)', async () => {
        ...
        ora(`FRENO TIRATO\tkill_switch=${dopo.kill_switch}\torder_mode=${dopo.order_mode}`);
    ...
    it('F2 rilascia il freno (doppia conferma)', async () => {
        ...
        ora(`FRENO RILASCIATO\tkill_switch=${dopo.kill_switch}\torder_mode=${dopo.order_mode}`);
