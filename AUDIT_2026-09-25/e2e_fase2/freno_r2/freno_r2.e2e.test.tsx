...
const OUT = resolve(MAIN, 'freno_r2');
...
describe('FASE 2 — RIAVVIO 2 — Z13.4 freno (2° ciclo)', () => {
    ...
    it('F1 tira il freno (un clic)', async () => {
        ...
        ora(`R2 FRENO TIRATO\tkill_switch=${dopo.kill_switch}\torder_mode=${dopo.order_mode}`);
    ...
    it('F2 rilascia il freno (doppia conferma)', async () => {
        ...
        ora(`R2 FRENO RILASCIATO\tkill_switch=${dopo.kill_switch}\torder_mode=${dopo.order_mode}`);
