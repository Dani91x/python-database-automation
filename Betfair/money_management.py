...
# ---------------------------------------------------------------------------
#  TABELLA DI CALIBRAZIONE — Aggiornata il 2026-05-18 da update_poisson_calibration.py
#  Derivata da 58999 match storici
...
CALIBRATION_TABLE = {
    ...
    "H": {0: 0.397, 1: 0.781, 2: 1.091, 3: 1.019, 4: 1.008, 5: 0.983, 6: 0.976, 7: 1.055, 8: 1.088, 9: 1.0},
    # 1X2 Draw
    "D": {0: 0.2, 1: 0.92, 2: 0.964, 3: 0.989, 4: 1.292, 5: 1.251, 6: 1.0, 7: 1.0, 8: 1.0, 9: 1.0},
    # 1X2 Away
    "A": {0: 1.187, 1: 1.062, 2: 1.03, 3: 0.988, 4: 0.968, 5: 1.008, 6: 1.068, 7: 1.075, 8: 1.0, 9: 1.0},
    # Over 2.5
    "O25": {0: 3.0, 1: 1.675, 2: 1.307, 3: 1.146, 4: 1.054, 5: 0.98, 6: 0.914, 7: 0.886, 8: 0.94, 9: 1.034},
    # Under 2.5
    "U25": {0: 0.631, 1: 1.292, 2: 1.329, 3: 1.155, 4: 1.025, 5: 0.955, 6: 0.919, 7: 0.893, 8: 0.867, 9: 0.848},
    # BTTS Si
    "BTTS": {0: 1.0, 1: 1.725, 2: 1.226, 3: 1.147, 4: 1.011, 5: 0.951, 6: 0.828, 7: 0.787, 8: 0.846, 9: 1.0},
    # BTTS No
    "BTTS_NO": {0: 1.0, 1: 1.735, 2: 1.595, 3: 1.31, 4: 1.059, 5: 0.991, 6: 0.916, 7: 0.92, 8: 0.865, 9: 1.0},
    # 1H Over 0.5
    "HT05": {0: 1.0, 1: 1.0, 2: 2.492, 3: 1.961, 4: 1.348, 5: 1.178, 6: 1.057, 7: 0.963, 8: 0.874, 9: 0.906},
    # Over 1.5
    "O15": {0: 1.0, 1: 1.0, 2: 1.605, 3: 1.157, 4: 1.046, 5: 1.058, 6: 1.007, 7: 0.968, 8: 0.914, 9: 0.905},
    # Under 1.5
    "U15": {0: 2.163, 1: 1.464, 2: 1.097, 3: 0.985, 4: 0.926, 5: 0.961, 6: 0.912, 7: 0.792, 8: 1.0, 9: 1.0},
    # Over 3.5
    "O35": {0: 2.074, 1: 1.313, 2: 1.117, 3: 0.969, 4: 0.87, 5: 0.829, 6: 0.919, 7: 0.806, 8: 1.0, 9: 1.0},
    # Under 3.5
    "U35": {0: 1.0, 1: 1.0, 2: 1.551, 3: 1.145, 4: 1.202, 5: 1.103, 6: 1.016, 7: 0.961, 8: 0.942, 9: 0.919},
    # HT Casa
    "HT_H": {0: 0.984, 1: 1.292, 2: 1.155, 3: 1.02, 4: 0.974, 5: 1.009, 6: 1.038, 7: 1.0, 8: 1.0, 9: 1.0},
    # HT Pareggio
    "HT_D": {0: 1.0, 1: 1.0, 2: 0.9, 3: 0.94, 4: 0.923, 5: 0.874, 6: 0.81, 7: 0.709, 8: 1.0, 9: 1.0},
    # HT Trasferta
    "HT_A": {0: 1.084, 1: 1.184, 2: 1.071, 3: 0.999, 4: 0.982, 5: 1.105, 6: 1.246, 7: 1.0, 8: 1.0, 9: 1.0},
    # 1H Under 0.5
    "HT_U05": {0: 2.087, 1: 1.67, 2: 1.11, 3: 0.893, 4: 0.777, 5: 0.702, 6: 0.487, 7: 0.425, 8: 1.0, 9: 1.0},
}
