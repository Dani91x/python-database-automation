...
# ---------------------------------------------------------------------------
#  TABELLA DI CALIBRAZIONE — Aggiornata il 2026-05-25 da update_poisson_calibration.py
#  Derivata da 61229 match storici
...
CALIBRATION_TABLE = {
    ...
    "H": {0: 0.781, 1: 0.734, 2: 1.06, 3: 1.029, 4: 1.012, 5: 1.002, 6: 1.008, 7: 1.075, 8: 1.119, 9: 1.0},
    # 1X2 Draw
    "D": {0: 0.2, 1: 0.904, 2: 0.958, 3: 0.965, 4: 1.269, 5: 1.362, 6: 1.0, 7: 1.0, 8: 1.0, 9: 1.0},
    # 1X2 Away
    "A": {0: 0.939, 1: 1.046, 2: 1.019, 3: 0.984, 4: 1.018, 5: 1.031, 6: 0.976, 7: 1.029, 8: 1.0, 9: 1.0},
    # Over 2.5
    "O25": {0: 1.938, 1: 1.501, 2: 1.3, 3: 1.175, 4: 1.051, 5: 0.992, 6: 0.931, 7: 0.869, 8: 0.898, 9: 0.885},
    # Under 2.5
    "U25": {0: 2.318, 1: 1.485, 2: 1.377, 3: 1.123, 4: 1.01, 5: 0.958, 6: 0.903, 7: 0.896, 8: 0.902, 9: 0.928},
    # BTTS Si
    "BTTS": {0: 1.0, 1: 1.457, 2: 1.247, 3: 1.144, 4: 1.023, 5: 0.952, 6: 0.849, 7: 0.763, 8: 0.836, 9: 1.0},
    # BTTS No
    "BTTS_NO": {0: 1.0, 1: 1.776, 2: 1.657, 3: 1.272, 4: 1.059, 5: 0.981, 6: 0.919, 7: 0.91, 8: 0.909, 9: 1.0},
    # 1H Over 0.5
    "HT05": {0: 1.0, 1: 1.0, 2: 2.642, 3: 1.83, 4: 1.363, 5: 1.172, 6: 1.059, 7: 0.958, 8: 0.885, 9: 0.86},
    # Over 1.5
    "O15": {0: 1.0, 1: 1.0, 2: 1.007, 3: 1.119, 4: 1.067, 5: 1.055, 6: 1.027, 7: 0.973, 8: 0.925, 9: 0.896},
    # Under 1.5
    "U15": {0: 2.264, 1: 1.408, 2: 1.081, 3: 0.949, 4: 0.93, 5: 0.943, 6: 0.933, 7: 0.998, 8: 1.0, 9: 1.0},
    # Over 3.5
    "O35": {0: 1.846, 1: 1.358, 2: 1.09, 3: 0.998, 4: 0.915, 5: 0.832, 6: 0.827, 7: 0.77, 8: 1.0, 9: 1.0},
    # Under 3.5
    "U35": {0: 1.0, 1: 1.0, 2: 1.61, 3: 1.307, 4: 1.198, 5: 1.068, 6: 1.001, 7: 0.97, 8: 0.934, 9: 0.935},
    # HT Casa
    "HT_H": {0: 1.936, 1: 1.243, 2: 1.171, 3: 1.03, 4: 0.958, 5: 1.023, 6: 1.105, 7: 1.179, 8: 1.0, 9: 1.0},
    # HT Pareggio
    "HT_D": {0: 1.0, 1: 1.0, 2: 0.694, 3: 0.942, 4: 0.924, 5: 0.891, 6: 0.803, 7: 0.684, 8: 1.0, 9: 1.0},
    # HT Trasferta
    "HT_A": {0: 1.195, 1: 1.169, 2: 1.046, 3: 0.999, 4: 1.005, 5: 1.007, 6: 1.173, 7: 1.0, 8: 1.0, 9: 1.0},
    # 1H Under 0.5
    "HT_U05": {0: 2.61, 1: 1.618, 2: 1.125, 3: 0.888, 4: 0.785, 5: 0.69, 6: 0.553, 7: 0.377, 8: 1.0, 9: 1.0},
}
