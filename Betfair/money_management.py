...
# ---------------------------------------------------------------------------
#  TABELLA DI CALIBRAZIONE — Aggiornata il 2026-04-20 da update_poisson_calibration.py
#  Derivata da 46450 match storici
...
CALIBRATION_TABLE = {
    ...
    "H": {0: 0.2, 1: 0.704, 2: 1.05, 3: 1.01, 4: 1.039, 5: 1.047, 6: 1.034, 7: 1.086, 8: 1.16, 9: 1.0},
    # 1X2 Draw
    "D": {0: 1.0, 1: 0.817, 2: 0.949, 3: 0.936, 4: 1.091, 5: 1.0, 6: 1.0, 7: 1.0, 8: 1.0, 9: 1.0},
    # 1X2 Away
    "A": {0: 0.489, 1: 1.007, 2: 0.982, 3: 1.014, 4: 1.043, 5: 1.048, 6: 1.027, 7: 1.313, 8: 1.0, 9: 1.0},
    # Over 2.5
    "O25": {0: 0.435, 1: 1.565, 2: 1.231, 3: 1.175, 4: 1.067, 5: 0.967, 6: 0.911, 7: 0.906, 8: 0.845, 9: 1.0},
    # Under 2.5
    "U25": {0: 1.0, 1: 1.787, 2: 1.268, 3: 1.159, 4: 1.04, 5: 0.946, 6: 0.902, 7: 0.92, 8: 0.888, 9: 1.047},
    # BTTS Si
    "BTTS": {0: 1.0, 1: 1.639, 2: 1.202, 3: 1.145, 4: 1.026, 5: 0.944, 6: 0.857, 7: 0.794, 8: 0.826, 9: 1.0},
    # BTTS No
    "BTTS_NO": {0: 1.0, 1: 1.806, 2: 1.571, 3: 1.254, 4: 1.069, 5: 0.978, 6: 0.919, 7: 0.927, 8: 0.865, 9: 1.0},
    # 1H Over 0.5
    "HT05": {0: 1.0, 1: 1.0, 2: 2.685, 3: 1.695, 4: 1.36, 5: 1.144, 6: 1.041, 7: 0.943, 8: 0.863, 9: 0.838},
    # Over 1.5
    "O15": {0: 1.0, 1: 1.0, 2: 1.0, 3: 1.245, 4: 1.074, 5: 1.047, 6: 1.03, 7: 0.95, 8: 0.927, 9: 0.937},
    # Under 1.5
    "U15": {0: 1.766, 1: 1.389, 2: 1.153, 3: 0.943, 4: 0.939, 5: 0.936, 6: 0.862, 7: 1.0, 8: 1.0, 9: 1.0},
    # Over 3.5
    "O35": {0: 1.484, 1: 1.309, 2: 1.065, 3: 0.943, 4: 0.843, 5: 0.802, 6: 0.865, 7: 0.886, 8: 1.0, 9: 1.0},
    # Under 3.5
    "U35": {0: 1.0, 1: 1.0, 2: 1.292, 3: 1.242, 4: 1.235, 5: 1.125, 6: 1.03, 7: 0.979, 8: 0.943, 9: 0.962},
    # HT Casa
    "HT_H": {0: 2.395, 1: 1.264, 2: 1.131, 3: 0.999, 4: 0.997, 5: 0.941, 6: 1.111, 7: 1.0, 8: 1.0, 9: 1.0},
    # HT Pareggio
    "HT_D": {0: 1.0, 1: 1.0, 2: 0.737, 3: 0.972, 4: 0.937, 5: 0.933, 6: 0.772, 7: 1.0, 8: 1.0, 9: 1.0},
    # HT Trasferta
    "HT_A": {0: 1.387, 1: 1.096, 2: 1.048, 3: 0.995, 4: 1.007, 5: 1.003, 6: 1.0, 7: 1.0, 8: 1.0, 9: 1.0},
    # 1H Under 0.5
    "HT_U05": {0: 2.855, 1: 1.733, 2: 1.168, 3: 0.924, 4: 0.819, 5: 0.694, 6: 0.622, 7: 0.369, 8: 1.0, 9: 1.0},
}
