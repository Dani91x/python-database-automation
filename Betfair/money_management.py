...
# ---------------------------------------------------------------------------
#  TABELLA DI CALIBRAZIONE — Aggiornata il 2026-08-10 da update_poisson_calibration.py
#  Derivata da 71956 match storici
...
CALIBRATION_TABLE = {
    ...
    "H": {0: 1.479, 1: 0.863, 2: 1.079, 3: 1.04, 4: 1.037, 5: 1.013, 6: 1.018, 7: 1.077, 8: 1.023, 9: 1.0},
    # 1X2 Draw
    "D": {0: 0.2, 1: 0.953, 2: 0.929, 3: 0.943, 4: 1.173, 5: 0.863, 6: 1.0, 7: 1.0, 8: 1.0, 9: 1.0},
    # 1X2 Away
    "A": {0: 1.104, 1: 1.005, 2: 1.019, 3: 0.999, 4: 1.013, 5: 1.026, 6: 0.959, 7: 1.047, 8: 1.0, 9: 1.0},
    # Over 2.5
    "O25": {0: 3.0, 1: 1.8, 2: 1.254, 3: 1.223, 4: 1.086, 5: 1.022, 6: 0.961, 7: 0.939, 8: 0.898, 9: 0.91},
    # Under 2.5
    "U25": {0: 2.115, 1: 1.514, 2: 1.176, 3: 1.07, 4: 0.975, 5: 0.929, 6: 0.877, 7: 0.911, 8: 0.843, 9: 0.784},
    # BTTS Si
    "BTTS": {0: 1.0, 1: 2.229, 2: 1.377, 3: 1.192, 4: 1.052, 5: 0.964, 6: 0.875, 7: 0.837, 8: 0.846, 9: 1.0},
    # BTTS No
    "BTTS_NO": {0: 1.0, 1: 1.71, 2: 1.462, 3: 1.225, 4: 1.044, 5: 0.957, 6: 0.893, 7: 0.865, 8: 0.761, 9: 1.0},
    # 1H Over 0.5
    "HT05": {0: 1.0, 1: 1.0, 2: 2.668, 3: 1.733, 4: 1.349, 5: 1.164, 6: 1.063, 7: 0.981, 8: 0.895, 9: 0.832},
    # Over 1.5
    "O15": {0: 1.0, 1: 1.0, 2: 1.634, 3: 1.305, 4: 1.147, 5: 1.073, 6: 1.047, 7: 0.981, 8: 0.946, 9: 0.937},
    # Under 1.5
    "U15": {0: 1.808, 1: 1.294, 2: 1.057, 3: 0.91, 4: 0.908, 5: 0.875, 6: 0.83, 7: 0.779, 8: 1.0, 9: 1.0},
    # Over 3.5
    "O35": {0: 2.113, 1: 1.423, 2: 1.143, 3: 1.022, 4: 0.958, 5: 0.887, 6: 0.895, 7: 0.897, 8: 0.853, 9: 1.0},
    # Under 3.5
    "U35": {0: 1.0, 1: 1.854, 2: 1.294, 3: 1.183, 4: 1.135, 5: 1.034, 6: 0.988, 7: 0.952, 8: 0.921, 9: 0.92},
    # HT Casa
    "HT_H": {0: 1.529, 1: 1.315, 2: 1.157, 3: 1.035, 4: 1.005, 5: 1.007, 6: 1.114, 7: 1.286, 8: 1.0, 9: 1.0},
    # HT Pareggio
    "HT_D": {0: 1.0, 1: 0.561, 2: 0.895, 3: 0.939, 4: 0.914, 5: 0.877, 6: 0.836, 7: 0.737, 8: 1.0, 9: 1.0},
    # HT Trasferta
    "HT_A": {0: 1.384, 1: 1.156, 2: 1.056, 3: 1.01, 4: 0.983, 5: 0.937, 6: 1.055, 7: 1.0, 8: 1.0, 9: 1.0},
    # 1H Under 0.5
    "HT_U05": {0: 2.937, 1: 1.552, 2: 1.059, 3: 0.88, 4: 0.794, 5: 0.7, 6: 0.6, 7: 0.371, 8: 1.0, 9: 1.0},
}
