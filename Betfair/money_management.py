...
# ---------------------------------------------------------------------------
#  TABELLA DI CALIBRAZIONE — Aggiornata il 2026-06-22 da update_poisson_calibration.py
#  Derivata da 66055 match storici
...
CALIBRATION_TABLE = {
    ...
    "H": {0: 0.2, 1: 0.992, 2: 1.079, 3: 0.974, 4: 1.016, 5: 1.003, 6: 0.999, 7: 1.077, 8: 1.067, 9: 1.0},
    # 1X2 Draw
    "D": {0: 0.2, 1: 0.896, 2: 0.953, 3: 0.988, 4: 1.108, 5: 0.716, 6: 1.0, 7: 1.0, 8: 1.0, 9: 1.0},
    # 1X2 Away
    "A": {0: 1.267, 1: 1.036, 2: 1.007, 3: 1.031, 4: 1.005, 5: 1.018, 6: 0.99, 7: 1.172, 8: 1.0, 9: 1.0},
    # Over 2.5
    "O25": {0: 3.0, 1: 1.823, 2: 1.291, 3: 1.228, 4: 1.089, 5: 1.018, 6: 0.929, 7: 0.918, 8: 0.97, 9: 1.008},
    # Under 2.5
    "U25": {0: 0.906, 1: 1.142, 2: 1.238, 3: 1.129, 4: 0.979, 5: 0.927, 6: 0.874, 7: 0.898, 8: 0.841, 9: 0.69},
    # BTTS Si
    "BTTS": {0: 1.0, 1: 2.017, 2: 1.272, 3: 1.117, 4: 1.048, 5: 0.946, 6: 0.861, 7: 0.811, 8: 0.846, 9: 1.0},
    # BTTS No
    "BTTS_NO": {0: 1.0, 1: 1.723, 2: 1.531, 3: 1.251, 4: 1.066, 5: 0.96, 6: 0.934, 7: 0.902, 8: 0.8, 9: 1.0},
    # 1H Over 0.5
    "HT05": {0: 1.0, 1: 1.0, 2: 2.554, 3: 1.773, 4: 1.377, 5: 1.18, 6: 1.057, 7: 0.967, 8: 0.891, 9: 0.881},
    # Over 1.5
    "O15": {0: 1.0, 1: 1.0, 2: 1.881, 3: 1.221, 4: 1.083, 5: 1.045, 6: 1.026, 7: 0.969, 8: 0.934, 9: 0.928},
    # Under 1.5
    "U15": {0: 1.892, 1: 1.359, 2: 1.093, 3: 0.951, 4: 0.943, 5: 0.929, 6: 0.875, 7: 0.696, 8: 1.0, 9: 1.0},
    # Over 3.5
    "O35": {0: 2.311, 1: 1.407, 2: 1.153, 3: 1.018, 4: 0.947, 5: 0.891, 6: 0.881, 7: 0.939, 8: 1.0, 9: 1.0},
    # Under 3.5
    "U35": {0: 1.0, 1: 1.0, 2: 1.209, 3: 1.206, 4: 1.131, 5: 1.043, 6: 0.99, 7: 0.949, 8: 0.925, 9: 0.903},
    # HT Casa
    "HT_H": {0: 1.438, 1: 1.361, 2: 1.148, 3: 1.038, 4: 0.995, 5: 0.99, 6: 1.024, 7: 1.347, 8: 1.0, 9: 1.0},
    # HT Pareggio
    "HT_D": {0: 1.0, 1: 1.0, 2: 0.785, 3: 0.943, 4: 0.913, 5: 0.894, 6: 0.717, 7: 0.77, 8: 1.0, 9: 1.0},
    # HT Trasferta
    "HT_A": {0: 1.189, 1: 1.154, 2: 1.048, 3: 1.05, 4: 0.895, 5: 1.238, 6: 1.428, 7: 1.0, 8: 1.0, 9: 1.0},
    # 1H Under 0.5
    "HT_U05": {0: 2.374, 1: 1.576, 2: 1.098, 3: 0.891, 4: 0.775, 5: 0.677, 6: 0.58, 7: 0.42, 8: 1.0, 9: 1.0},
}
