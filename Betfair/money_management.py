...
# ---------------------------------------------------------------------------
#  TABELLA DI CALIBRAZIONE — Aggiornata il 2026-06-29 da update_poisson_calibration.py
#  Derivata da 67035 match storici
...
CALIBRATION_TABLE = {
    ...
    "H": {0: 0.309, 1: 0.844, 2: 1.109, 3: 1.036, 4: 1.013, 5: 1.013, 6: 1.019, 7: 1.059, 8: 1.051, 9: 1.0},
    # 1X2 Draw
    "D": {0: 0.2, 1: 0.907, 2: 0.941, 3: 0.957, 4: 1.122, 5: 0.993, 6: 1.0, 7: 1.0, 8: 1.0, 9: 1.0},
    # 1X2 Away
    "A": {0: 1.29, 1: 1.057, 2: 1.021, 3: 0.986, 4: 0.983, 5: 1.051, 6: 1.054, 7: 1.058, 8: 1.0, 9: 1.0},
    # Over 2.5
    "O25": {0: 3.0, 1: 1.824, 2: 1.266, 3: 1.198, 4: 1.064, 5: 1.011, 6: 0.952, 7: 0.914, 8: 0.958, 9: 1.012},
    # Under 2.5
    "U25": {0: 0.853, 1: 1.2, 2: 1.248, 3: 1.086, 4: 0.987, 5: 0.948, 6: 0.89, 7: 0.909, 8: 0.839, 9: 0.784},
    # BTTS Si
    "BTTS": {0: 1.0, 1: 2.229, 2: 1.284, 3: 1.11, 4: 1.048, 5: 0.965, 6: 0.874, 7: 0.806, 8: 0.836, 9: 1.0},
    # BTTS No
    "BTTS_NO": {0: 1.0, 1: 1.791, 2: 1.542, 3: 1.225, 4: 1.043, 5: 0.959, 6: 0.938, 7: 0.899, 8: 0.763, 9: 1.0},
    # 1H Over 0.5
    "HT05": {0: 1.0, 1: 1.0, 2: 2.541, 3: 1.768, 4: 1.357, 5: 1.163, 6: 1.061, 7: 0.961, 8: 0.892, 9: 0.879},
    # Over 1.5
    "O15": {0: 1.0, 1: 1.0, 2: 1.833, 3: 1.163, 4: 1.086, 5: 1.049, 6: 1.035, 7: 0.978, 8: 0.937, 9: 0.922},
    # Under 1.5
    "U15": {0: 1.979, 1: 1.343, 2: 1.067, 3: 0.934, 4: 0.937, 5: 0.926, 6: 0.908, 7: 0.705, 8: 1.0, 9: 1.0},
    # Over 3.5
    "O35": {0: 2.123, 1: 1.353, 2: 1.118, 3: 1.021, 4: 0.916, 5: 0.882, 6: 0.92, 7: 0.96, 8: 0.942, 9: 1.0},
    # Under 3.5
    "U35": {0: 1.0, 1: 1.367, 2: 1.109, 3: 1.137, 4: 1.141, 5: 1.067, 6: 0.989, 7: 0.961, 8: 0.934, 9: 0.916},
    # HT Casa
    "HT_H": {0: 1.421, 1: 1.257, 2: 1.182, 3: 1.036, 4: 0.985, 5: 0.981, 6: 1.13, 7: 1.0, 8: 1.0, 9: 1.0},
    # HT Pareggio
    "HT_D": {0: 1.0, 1: 1.0, 2: 0.725, 3: 0.96, 4: 0.907, 5: 0.89, 6: 0.765, 7: 0.817, 8: 1.0, 9: 1.0},
    # HT Trasferta
    "HT_A": {0: 1.322, 1: 1.145, 2: 1.061, 3: 1.004, 4: 0.99, 5: 1.063, 6: 1.404, 7: 1.0, 8: 1.0, 9: 1.0},
    # 1H Under 0.5
    "HT_U05": {0: 2.388, 1: 1.573, 2: 1.118, 3: 0.883, 4: 0.797, 5: 0.694, 6: 0.583, 7: 0.421, 8: 1.0, 9: 1.0},
}
