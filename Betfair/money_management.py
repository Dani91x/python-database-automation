...
# ---------------------------------------------------------------------------
#  TABELLA DI CALIBRAZIONE — Aggiornata il 2026-08-24 da update_poisson_calibration.py
#  Derivata da 73298 match storici
...
CALIBRATION_TABLE = {
    ...
    "H": {0: 0.972, 1: 1.018, 2: 1.036, 3: 1.032, 4: 1.013, 5: 0.991, 6: 1.01, 7: 1.085, 8: 0.995, 9: 1.0},
    # 1X2 Draw
    "D": {0: 0.2, 1: 0.89, 2: 0.938, 3: 0.978, 4: 1.208, 5: 1.103, 6: 1.0, 7: 1.0, 8: 1.0, 9: 1.0},
    # 1X2 Away
    "A": {0: 1.229, 1: 1.036, 2: 1.04, 3: 0.992, 4: 0.996, 5: 1.046, 6: 0.98, 7: 1.056, 8: 1.0, 9: 1.0},
    # Over 2.5
    "O25": {0: 2.615, 1: 1.677, 2: 1.25, 3: 1.197, 4: 1.077, 5: 1.01, 6: 0.944, 7: 0.911, 8: 0.907, 9: 0.96},
    # Under 2.5
    "U25": {0: 1.495, 1: 1.471, 2: 1.256, 3: 1.099, 4: 0.988, 5: 0.937, 6: 0.891, 7: 0.913, 8: 0.869, 9: 0.879},
    # BTTS Si
    "BTTS": {0: 1.0, 1: 1.832, 2: 1.351, 3: 1.159, 4: 1.043, 5: 0.96, 6: 0.858, 7: 0.797, 8: 0.826, 9: 1.0},
    # BTTS No
    "BTTS_NO": {0: 1.0, 1: 1.811, 2: 1.569, 3: 1.257, 4: 1.049, 5: 0.964, 6: 0.911, 7: 0.873, 8: 0.839, 9: 1.0},
    # 1H Over 0.5
    "HT05": {0: 1.0, 1: 1.0, 2: 2.737, 3: 1.714, 4: 1.369, 5: 1.174, 6: 1.054, 7: 0.968, 8: 0.886, 9: 0.859},
    # Over 1.5
    "O15": {0: 1.0, 1: 1.0, 2: 1.239, 3: 1.243, 4: 1.139, 5: 1.088, 6: 1.029, 7: 0.972, 8: 0.931, 9: 0.928},
    # Under 1.5
    "U15": {0: 1.911, 1: 1.376, 2: 1.084, 3: 0.945, 4: 0.888, 5: 0.883, 6: 0.862, 7: 0.918, 8: 1.0, 9: 1.0},
    # Over 3.5
    "O35": {0: 1.918, 1: 1.381, 2: 1.121, 3: 1.003, 4: 0.924, 5: 0.877, 6: 0.892, 7: 0.917, 8: 0.92, 9: 1.0},
    # Under 3.5
    "U35": {0: 1.0, 1: 1.438, 2: 1.235, 3: 1.192, 4: 1.146, 5: 1.06, 6: 0.998, 7: 0.96, 8: 0.93, 9: 0.933},
    # HT Casa
    "HT_H": {0: 2.011, 1: 1.268, 2: 1.185, 3: 1.019, 4: 0.974, 5: 1.025, 6: 1.061, 7: 1.3, 8: 1.0, 9: 1.0},
    # HT Pareggio
    "HT_D": {0: 1.0, 1: 1.0, 2: 0.836, 3: 0.948, 4: 0.922, 5: 0.87, 6: 0.789, 7: 0.665, 8: 1.0, 9: 1.0},
    # HT Trasferta
    "HT_A": {0: 1.511, 1: 1.172, 2: 1.053, 3: 1.011, 4: 0.945, 5: 0.935, 6: 1.217, 7: 1.0, 8: 1.0, 9: 1.0},
    # 1H Under 0.5
    "HT_U05": {0: 2.617, 1: 1.604, 2: 1.094, 3: 0.897, 4: 0.782, 5: 0.684, 6: 0.611, 7: 0.349, 8: 1.0, 9: 1.0},
}
