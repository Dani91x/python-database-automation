...
# ---------------------------------------------------------------------------
#  TABELLA DI CALIBRAZIONE — Aggiornata il 2026-07-13 da update_poisson_calibration.py
#  Derivata da 68696 match storici
...
CALIBRATION_TABLE = {
    ...
    "H": {0: 0.956, 1: 0.921, 2: 1.061, 3: 1.013, 4: 1.028, 5: 1.035, 6: 1.04, 7: 1.054, 8: 1.036, 9: 1.0},
    # 1X2 Draw
    "D": {0: 0.2, 1: 0.96, 2: 0.917, 3: 0.962, 4: 1.083, 5: 0.646, 6: 1.0, 7: 1.0, 8: 1.0, 9: 1.0},
    # 1X2 Away
    "A": {0: 1.15, 1: 1.053, 2: 1.007, 3: 0.998, 4: 1.035, 5: 1.066, 6: 0.97, 7: 1.136, 8: 1.0, 9: 1.0},
    # Over 2.5
    "O25": {0: 3.0, 1: 1.752, 2: 1.308, 3: 1.192, 4: 1.065, 5: 1.025, 6: 0.947, 7: 0.929, 8: 0.898, 9: 1.055},
    # Under 2.5
    "U25": {0: 0.274, 1: 1.5, 2: 1.203, 3: 1.095, 4: 0.971, 5: 0.946, 6: 0.894, 7: 0.893, 8: 0.856, 9: 0.658},
    # BTTS Si
    "BTTS": {0: 1.0, 1: 2.466, 2: 1.232, 3: 1.135, 4: 1.043, 5: 0.959, 6: 0.88, 7: 0.823, 8: 0.901, 9: 1.0},
    # BTTS No
    "BTTS_NO": {0: 1.0, 1: 1.467, 2: 1.497, 3: 1.216, 4: 1.051, 5: 0.965, 6: 0.924, 7: 0.917, 8: 0.71, 9: 1.0},
    # 1H Over 0.5
    "HT05": {0: 1.0, 1: 1.0, 2: 2.561, 3: 1.859, 4: 1.353, 5: 1.156, 6: 1.053, 7: 0.97, 8: 0.892, 9: 0.876},
    # Over 1.5
    "O15": {0: 1.0, 1: 1.0, 2: 2.051, 3: 1.265, 4: 1.113, 5: 1.061, 6: 1.046, 7: 0.976, 8: 0.938, 9: 0.931},
    # Under 1.5
    "U15": {0: 1.865, 1: 1.338, 2: 1.072, 3: 0.913, 4: 0.922, 5: 0.906, 6: 0.847, 7: 0.634, 8: 1.0, 9: 1.0},
    # Over 3.5
    "O35": {0: 2.31, 1: 1.388, 2: 1.125, 3: 1.029, 4: 0.945, 5: 0.904, 6: 0.879, 7: 0.844, 8: 1.037, 9: 1.0},
    # Under 3.5
    "U35": {0: 1.0, 1: 0.796, 2: 1.456, 3: 1.212, 4: 1.114, 5: 1.044, 6: 0.985, 7: 0.958, 8: 0.928, 9: 0.904},
    # HT Casa
    "HT_H": {0: 1.531, 1: 1.228, 2: 1.148, 3: 1.02, 4: 1.012, 5: 1.006, 6: 1.123, 7: 1.251, 8: 1.0, 9: 1.0},
    # HT Pareggio
    "HT_D": {0: 1.0, 1: 1.0, 2: 0.846, 3: 0.933, 4: 0.929, 5: 0.878, 6: 0.794, 7: 0.792, 8: 1.0, 9: 1.0},
    # HT Trasferta
    "HT_A": {0: 1.069, 1: 1.178, 2: 1.046, 3: 1.028, 4: 0.983, 5: 1.015, 6: 1.077, 7: 1.0, 8: 1.0, 9: 1.0},
    # 1H Under 0.5
    "HT_U05": {0: 2.407, 1: 1.568, 2: 1.09, 3: 0.9, 4: 0.806, 5: 0.699, 6: 0.532, 7: 0.416, 8: 1.0, 9: 1.0},
}
