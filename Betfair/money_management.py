...
# ---------------------------------------------------------------------------
#  TABELLA DI CALIBRAZIONE — Aggiornata il 2026-04-13 da update_poisson_calibration.py
#  Derivata da 43340 match storici
...
CALIBRATION_TABLE = {
    ...
    "H": {0: 0.309, 1: 0.796, 2: 1.1, 3: 1.053, 4: 1.037, 5: 1.042, 6: 1.07, 7: 1.101, 8: 1.099, 9: 1.0},
    # 1X2 Draw
    "D": {0: 1.0, 1: 0.608, 2: 0.912, 3: 0.913, 4: 1.201, 5: 1.0, 6: 1.0, 7: 1.0, 8: 1.0, 9: 1.0},
    # 1X2 Away
    "A": {0: 1.117, 1: 1.002, 2: 1.035, 3: 0.998, 4: 1.024, 5: 1.009, 6: 1.033, 7: 1.158, 8: 1.0, 9: 1.0},
    # Over 2.5
    "O25": {0: 1.0, 1: 1.496, 2: 1.308, 3: 1.19, 4: 1.058, 5: 0.957, 6: 0.932, 7: 0.927, 8: 0.911, 9: 1.0},
    # Under 2.5
    "U25": {0: 1.0, 1: 1.448, 2: 1.206, 3: 1.123, 4: 1.053, 5: 0.952, 6: 0.895, 7: 0.892, 8: 0.9, 9: 1.0},
    # BTTS Si
    "BTTS": {0: 1.0, 1: 1.496, 2: 1.216, 3: 1.128, 4: 1.048, 5: 0.932, 6: 0.826, 7: 0.83, 8: 0.915, 9: 1.0},
    # BTTS No
    "BTTS_NO": {0: 1.0, 1: 1.398, 2: 1.467, 3: 1.313, 4: 1.084, 5: 0.959, 6: 0.927, 7: 0.924, 8: 0.9, 9: 1.0},
    # 1H Over 0.5
    "HT05": {0: 1.0, 1: 1.0, 2: 2.502, 3: 1.757, 4: 1.357, 5: 1.18, 6: 1.057, 7: 0.948, 8: 0.874, 9: 0.852},
    # Over 1.5
    "O15": {0: 1.0, 1: 1.0, 2: 1.0, 3: 1.176, 4: 1.086, 5: 1.083, 6: 1.048, 7: 0.957, 8: 0.924, 9: 0.935},
    # Under 1.5
    "U15": {0: 1.782, 1: 1.405, 2: 1.135, 3: 0.906, 4: 0.893, 5: 0.925, 6: 0.902, 7: 1.0, 8: 1.0, 9: 1.0},
    # Over 3.5
    "O35": {0: 1.688, 1: 1.354, 2: 1.099, 3: 0.93, 4: 0.872, 5: 0.84, 6: 0.875, 7: 0.901, 8: 1.0, 9: 1.0},
    # Under 3.5
    "U35": {0: 1.0, 1: 1.0, 2: 1.25, 3: 1.224, 4: 1.189, 5: 1.102, 6: 1.037, 7: 0.967, 8: 0.933, 9: 0.945},
    # HT Casa
    "HT_H": {0: 2.241, 1: 1.321, 2: 1.135, 3: 1.008, 4: 1.014, 5: 1.02, 6: 1.182, 7: 1.0, 8: 1.0, 9: 1.0},
    # HT Pareggio
    "HT_D": {0: 1.0, 1: 1.0, 2: 0.731, 3: 0.963, 4: 0.917, 5: 0.91, 6: 0.842, 7: 1.0, 8: 1.0, 9: 1.0},
    # HT Trasferta
    "HT_A": {0: 1.262, 1: 1.128, 2: 1.064, 3: 0.997, 4: 0.993, 5: 1.005, 6: 1.0, 7: 1.0, 8: 1.0, 9: 1.0},
    # 1H Under 0.5
    "HT_U05": {0: 2.658, 1: 1.678, 2: 1.153, 3: 0.896, 4: 0.774, 5: 0.695, 6: 0.595, 7: 0.425, 8: 1.0, 9: 1.0},
}
