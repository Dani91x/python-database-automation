...
# ---------------------------------------------------------------------------
#  TABELLA DI CALIBRAZIONE — Aggiornata il 2026-08-31 da update_poisson_calibration.py
#  Derivata da 74117 match storici
...
CALIBRATION_TABLE = {
    ...
    "H": {0: 0.843, 1: 0.949, 2: 1.081, 3: 1.034, 4: 1.011, 5: 1.006, 6: 1.022, 7: 1.044, 8: 0.95, 9: 1.0},
    # 1X2 Draw
    "D": {0: 0.2, 1: 0.922, 2: 0.933, 3: 0.971, 4: 1.15, 5: 1.063, 6: 1.0, 7: 1.0, 8: 1.0, 9: 1.0},
    # 1X2 Away
    "A": {0: 1.197, 1: 1.028, 2: 1.014, 3: 1.006, 4: 0.992, 5: 1.069, 6: 0.965, 7: 1.1, 8: 1.0, 9: 1.0},
    # Over 2.5
    "O25": {0: 3.0, 1: 1.799, 2: 1.272, 3: 1.18, 4: 1.083, 5: 1.026, 6: 0.957, 7: 0.91, 8: 0.917, 9: 0.895},
    # Under 2.5
    "U25": {0: 2.326, 1: 1.413, 2: 1.262, 3: 1.078, 4: 0.968, 5: 0.933, 6: 0.901, 7: 0.904, 8: 0.844, 9: 0.821},
    # BTTS Si
    "BTTS": {0: 1.0, 1: 1.927, 2: 1.286, 3: 1.177, 4: 1.037, 5: 0.978, 6: 0.876, 7: 0.815, 8: 0.852, 9: 1.0},
    # BTTS No
    "BTTS_NO": {0: 1.0, 1: 1.699, 2: 1.52, 3: 1.224, 4: 1.027, 5: 0.969, 6: 0.901, 7: 0.898, 8: 0.822, 9: 1.0},
    # 1H Over 0.5
    "HT05": {0: 1.0, 1: 1.0, 2: 2.854, 3: 1.71, 4: 1.37, 5: 1.177, 6: 1.06, 7: 0.974, 8: 0.891, 9: 0.889},
    # Over 1.5
    "O15": {0: 1.0, 1: 2.337, 2: 1.529, 3: 1.309, 4: 1.155, 5: 1.067, 6: 1.038, 7: 0.978, 8: 0.941, 9: 0.925},
    # Under 1.5
    "U15": {0: 1.957, 1: 1.325, 2: 1.068, 3: 0.926, 4: 0.914, 5: 0.869, 6: 0.829, 7: 0.818, 8: 0.729, 9: 1.0},
    # Over 3.5
    "O35": {0: 2.253, 1: 1.365, 2: 1.124, 3: 1.027, 4: 0.949, 5: 0.875, 6: 0.891, 7: 0.907, 8: 0.83, 9: 1.0},
    # Under 3.5
    "U35": {0: 1.0, 1: 1.925, 2: 1.262, 3: 1.192, 4: 1.15, 5: 1.04, 6: 0.986, 7: 0.959, 8: 0.932, 9: 0.91},
    # HT Casa
    "HT_H": {0: 1.22, 1: 1.319, 2: 1.174, 3: 1.028, 4: 0.983, 5: 1.004, 6: 1.027, 7: 1.204, 8: 1.0, 9: 1.0},
    # HT Pareggio
    "HT_D": {0: 1.0, 1: 1.0, 2: 0.814, 3: 0.95, 4: 0.913, 5: 0.869, 6: 0.745, 7: 0.83, 8: 1.0, 9: 1.0},
    # HT Trasferta
    "HT_A": {0: 1.394, 1: 1.202, 2: 1.057, 3: 1.012, 4: 0.963, 5: 0.937, 6: 1.218, 7: 1.0, 8: 1.0, 9: 1.0},
    # 1H Under 0.5
    "HT_U05": {0: 2.292, 1: 1.574, 2: 1.077, 3: 0.889, 4: 0.777, 5: 0.683, 6: 0.614, 7: 0.312, 8: 1.0, 9: 1.0},
}
