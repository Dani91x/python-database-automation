...
# ---------------------------------------------------------------------------
#  TABELLA DI CALIBRAZIONE — Aggiornata il 2026-09-07 da update_poisson_calibration.py
#  Derivata da 74715 match storici
...
CALIBRATION_TABLE = {
    ...
    "H": {0: 1.7, 1: 0.88, 2: 1.113, 3: 1.037, 4: 1.007, 5: 0.999, 6: 1.027, 7: 1.011, 8: 1.056, 9: 1.0},
    # 1X2 Draw
    "D": {0: 0.2, 1: 0.928, 2: 0.926, 3: 0.945, 4: 1.107, 5: 1.026, 6: 1.0, 7: 1.0, 8: 1.0, 9: 1.0},
    # 1X2 Away
    "A": {0: 1.256, 1: 1.062, 2: 1.041, 3: 1.007, 4: 0.998, 5: 1.073, 6: 1.035, 7: 1.028, 8: 1.0, 9: 1.0},
    # Over 2.5
    "O25": {0: 3.0, 1: 1.723, 2: 1.273, 3: 1.19, 4: 1.079, 5: 1.001, 6: 0.949, 7: 0.904, 8: 0.91, 9: 0.896},
    # Under 2.5
    "U25": {0: 2.294, 1: 1.451, 2: 1.277, 3: 1.091, 4: 1.0, 5: 0.935, 6: 0.895, 7: 0.904, 8: 0.858, 9: 0.81},
    # BTTS Si
    "BTTS": {0: 1.0, 1: 2.032, 2: 1.253, 3: 1.191, 4: 1.04, 5: 0.958, 6: 0.875, 7: 0.82, 8: 0.841, 9: 1.0},
    # BTTS No
    "BTTS_NO": {0: 1.0, 1: 1.75, 2: 1.506, 3: 1.228, 4: 1.051, 5: 0.967, 6: 0.893, 7: 0.91, 8: 0.8, 9: 1.0},
    # 1H Over 0.5
    "HT05": {0: 1.0, 1: 1.0, 2: 2.684, 3: 1.756, 4: 1.398, 5: 1.169, 6: 1.047, 7: 0.971, 8: 0.892, 9: 0.885},
    # Over 1.5
    "O15": {0: 1.0, 1: 1.0, 2: 1.718, 3: 1.205, 4: 1.16, 5: 1.066, 6: 1.029, 7: 0.975, 8: 0.936, 9: 0.918},
    # Under 1.5
    "U15": {0: 2.053, 1: 1.35, 2: 1.075, 3: 0.944, 4: 0.917, 5: 0.865, 6: 0.883, 7: 0.754, 8: 1.0, 9: 1.0},
    # Over 3.5
    "O35": {0: 2.167, 1: 1.382, 2: 1.131, 3: 1.027, 4: 0.927, 5: 0.862, 6: 0.92, 7: 0.824, 8: 0.901, 9: 1.0},
    # Under 3.5
    "U35": {0: 1.0, 1: 1.547, 2: 1.501, 3: 1.141, 4: 1.164, 5: 1.059, 6: 0.986, 7: 0.956, 8: 0.93, 9: 0.914},
    # HT Casa
    "HT_H": {0: 1.449, 1: 1.325, 2: 1.161, 3: 1.014, 4: 0.986, 5: 0.967, 6: 1.018, 7: 1.111, 8: 1.0, 9: 1.0},
    # HT Pareggio
    "HT_D": {0: 1.0, 1: 0.295, 2: 1.02, 3: 0.953, 4: 0.924, 5: 0.881, 6: 0.773, 7: 0.682, 8: 1.0, 9: 1.0},
    # HT Trasferta
    "HT_A": {0: 1.395, 1: 1.208, 2: 1.055, 3: 0.975, 4: 0.971, 5: 0.951, 6: 1.066, 7: 1.0, 8: 1.0, 9: 1.0},
    # 1H Under 0.5
    "HT_U05": {0: 2.321, 1: 1.57, 2: 1.087, 3: 0.913, 4: 0.786, 5: 0.66, 6: 0.594, 7: 0.366, 8: 1.0, 9: 1.0},
}
