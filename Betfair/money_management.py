...
# ---------------------------------------------------------------------------
#  TABELLA DI CALIBRAZIONE — Aggiornata il 2026-07-20 da update_poisson_calibration.py
#  Derivata da 69429 match storici
...
CALIBRATION_TABLE = {
    ...
    "H": {0: 1.059, 1: 0.771, 2: 1.049, 3: 1.02, 4: 1.033, 5: 1.005, 6: 0.995, 7: 1.045, 8: 1.02, 9: 1.0},
    # 1X2 Draw
    "D": {0: 0.2, 1: 1.024, 2: 0.923, 3: 0.953, 4: 1.157, 5: 0.896, 6: 1.0, 7: 1.0, 8: 1.0, 9: 1.0},
    # 1X2 Away
    "A": {0: 1.069, 1: 1.034, 2: 1.022, 3: 1.022, 4: 1.012, 5: 1.104, 6: 1.039, 7: 1.086, 8: 1.0, 9: 1.0},
    # Over 2.5
    "O25": {0: 3.0, 1: 1.73, 2: 1.257, 3: 1.22, 4: 1.086, 5: 1.034, 6: 0.972, 7: 0.939, 8: 0.911, 9: 0.986},
    # Under 2.5
    "U25": {0: 1.177, 1: 1.439, 2: 1.18, 3: 1.048, 4: 0.959, 5: 0.929, 6: 0.879, 7: 0.91, 8: 0.858, 9: 0.761},
    # BTTS Si
    "BTTS": {0: 1.0, 1: 1.986, 2: 1.361, 3: 1.173, 4: 1.039, 5: 0.965, 6: 0.886, 7: 0.837, 8: 0.796, 9: 1.0},
    # BTTS No
    "BTTS_NO": {0: 1.0, 1: 1.978, 2: 1.458, 3: 1.205, 4: 1.043, 5: 0.967, 6: 0.903, 7: 0.872, 8: 0.812, 9: 1.0},
    # 1H Over 0.5
    "HT05": {0: 1.0, 1: 1.0, 2: 2.607, 3: 1.738, 4: 1.379, 5: 1.181, 6: 1.061, 7: 0.98, 8: 0.893, 9: 0.869},
    # Over 1.5
    "O15": {0: 1.0, 1: 3.0, 2: 1.701, 3: 1.349, 4: 1.155, 5: 1.055, 6: 1.037, 7: 0.983, 8: 0.95, 9: 0.938},
    # Under 1.5
    "U15": {0: 1.788, 1: 1.274, 2: 1.052, 3: 0.929, 4: 0.93, 5: 0.869, 6: 0.807, 7: 0.758, 8: 0.553, 9: 1.0},
    # Over 3.5
    "O35": {0: 2.339, 1: 1.377, 2: 1.167, 3: 1.035, 4: 0.965, 5: 0.894, 6: 0.896, 7: 0.839, 8: 1.038, 9: 1.0},
    # Under 3.5
    "U35": {0: 1.0, 1: 0.817, 2: 1.464, 3: 1.181, 4: 1.126, 5: 1.028, 6: 0.982, 7: 0.944, 8: 0.93, 9: 0.904},
    # HT Casa
    "HT_H": {0: 1.908, 1: 1.234, 2: 1.16, 3: 1.052, 4: 0.98, 5: 0.995, 6: 1.102, 7: 1.222, 8: 1.0, 9: 1.0},
    # HT Pareggio
    "HT_D": {0: 1.0, 1: 1.0, 2: 0.792, 3: 0.947, 4: 0.903, 5: 0.886, 6: 0.756, 7: 0.746, 8: 1.0, 9: 1.0},
    # HT Trasferta
    "HT_A": {0: 1.263, 1: 1.182, 2: 1.053, 3: 1.023, 4: 1.04, 5: 1.129, 6: 1.102, 7: 1.0, 8: 1.0, 9: 1.0},
    # 1H Under 0.5
    "HT_U05": {0: 2.512, 1: 1.565, 2: 1.061, 3: 0.884, 4: 0.772, 5: 0.674, 6: 0.601, 7: 0.401, 8: 1.0, 9: 1.0},
}
