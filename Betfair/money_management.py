...
# ---------------------------------------------------------------------------
#  TABELLA DI CALIBRAZIONE — Aggiornata il 2026-09-21 da update_poisson_calibration.py
#  Derivata da 77592 match storici
...
CALIBRATION_TABLE = {
    ...
    "H": {0: 1.394, 1: 0.85, 2: 1.099, 3: 1.03, 4: 1.022, 5: 1.013, 6: 1.028, 7: 1.024, 8: 0.983, 9: 0.987},
    # 1X2 Draw
    "D": {0: 0.307, 1: 0.938, 2: 0.922, 3: 0.949, 4: 1.193, 5: 1.166, 6: 1.0, 7: 1.0, 8: 1.0, 9: 1.0},
    # 1X2 Away
    "A": {0: 1.213, 1: 1.052, 2: 1.025, 3: 1.01, 4: 0.996, 5: 1.046, 6: 1.027, 7: 1.052, 8: 1.0, 9: 1.0},
    # Over 2.5
    "O25": {0: 3.0, 1: 1.713, 2: 1.283, 3: 1.199, 4: 1.094, 5: 1.009, 6: 0.957, 7: 0.93, 8: 0.907, 9: 0.921},
    # Under 2.5
    "U25": {0: 1.948, 1: 1.474, 2: 1.203, 3: 1.077, 4: 0.99, 5: 0.924, 6: 0.889, 7: 0.901, 8: 0.86, 9: 0.848},
    # BTTS Si
    "BTTS": {0: 1.0, 1: 1.797, 2: 1.32, 3: 1.157, 4: 1.052, 5: 0.959, 6: 0.874, 7: 0.826, 8: 0.865, 9: 1.0},
    # BTTS No
    "BTTS_NO": {0: 1.0, 1: 1.641, 2: 1.49, 3: 1.229, 4: 1.049, 5: 0.957, 6: 0.911, 7: 0.886, 8: 0.847, 9: 1.0},
    # 1H Over 0.5
    "HT05": {0: 1.0, 1: 1.0, 2: 2.565, 3: 1.831, 4: 1.352, 5: 1.168, 6: 1.062, 7: 0.983, 8: 0.897, 9: 0.856},
    # Over 1.5
    "O15": {0: 1.0, 1: 2.67, 2: 1.238, 3: 1.207, 4: 1.167, 5: 1.079, 6: 1.045, 7: 0.983, 8: 0.942, 9: 0.926},
    # Under 1.5
    "U15": {0: 1.948, 1: 1.319, 2: 1.052, 3: 0.914, 4: 0.9, 5: 0.86, 6: 0.879, 7: 0.917, 8: 0.657, 9: 1.0},
    # Over 3.5
    "O35": {0: 2.059, 1: 1.407, 2: 1.156, 3: 1.013, 4: 0.937, 5: 0.915, 6: 0.887, 7: 0.8, 8: 0.864, 9: 1.0},
    # Under 3.5
    "U35": {0: 1.0, 1: 1.722, 2: 1.561, 3: 1.2, 4: 1.103, 5: 1.05, 6: 0.993, 7: 0.948, 8: 0.925, 9: 0.921},
    # HT Casa
    "HT_H": {0: 1.709, 1: 1.31, 2: 1.158, 3: 1.032, 4: 1.008, 5: 1.006, 6: 1.053, 7: 1.156, 8: 1.0, 9: 1.0},
    # HT Pareggio
    "HT_D": {0: 1.0, 1: 0.906, 2: 0.785, 3: 0.942, 4: 0.906, 5: 0.875, 6: 0.804, 7: 0.667, 8: 1.0, 9: 1.0},
    # HT Trasferta
    "HT_A": {0: 1.441, 1: 1.17, 2: 1.078, 3: 1.01, 4: 0.956, 5: 1.001, 6: 1.15, 7: 1.0, 8: 1.0, 9: 1.0},
    # 1H Under 0.5
    "HT_U05": {0: 2.639, 1: 1.541, 2: 1.051, 3: 0.882, 4: 0.789, 5: 0.698, 6: 0.544, 7: 0.419, 8: 1.0, 9: 1.0},
}
