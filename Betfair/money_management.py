...
# ---------------------------------------------------------------------------
#  TABELLA DI CALIBRAZIONE — Aggiornata il 2026-08-17 da update_poisson_calibration.py
#  Derivata da 72614 match storici
...
CALIBRATION_TABLE = {
    ...
    "H": {0: 0.718, 1: 0.947, 2: 1.114, 3: 1.017, 4: 1.02, 5: 0.99, 6: 1.018, 7: 1.059, 8: 1.082, 9: 1.0},
    # 1X2 Draw
    "D": {0: 0.2, 1: 0.909, 2: 0.947, 3: 0.969, 4: 1.135, 5: 1.185, 6: 1.0, 7: 1.0, 8: 1.0, 9: 1.0},
    # 1X2 Away
    "A": {0: 1.033, 1: 1.044, 2: 1.009, 3: 1.021, 4: 0.978, 5: 0.99, 6: 0.98, 7: 1.085, 8: 1.0, 9: 1.0},
    # Over 2.5
    "O25": {0: 2.765, 1: 1.781, 2: 1.245, 3: 1.201, 4: 1.073, 5: 1.016, 6: 0.939, 7: 0.911, 8: 0.892, 9: 1.049},
    # Under 2.5
    "U25": {0: 0.462, 1: 1.551, 2: 1.256, 3: 1.112, 4: 0.981, 5: 0.94, 6: 0.889, 7: 0.914, 8: 0.848, 9: 0.862},
    # BTTS Si
    "BTTS": {0: 1.0, 1: 1.795, 2: 1.329, 3: 1.143, 4: 1.035, 5: 0.948, 6: 0.871, 7: 0.831, 8: 0.826, 9: 1.0},
    # BTTS No
    "BTTS_NO": {0: 1.0, 1: 1.782, 2: 1.484, 3: 1.232, 4: 1.063, 5: 0.971, 6: 0.919, 7: 0.881, 8: 0.844, 9: 1.0},
    # 1H Over 0.5
    "HT05": {0: 1.0, 1: 1.0, 2: 2.426, 3: 1.747, 4: 1.379, 5: 1.171, 6: 1.068, 7: 0.974, 8: 0.894, 9: 0.849},
    # Over 1.5
    "O15": {0: 1.0, 1: 1.304, 2: 1.403, 3: 1.168, 4: 1.128, 5: 1.069, 6: 1.025, 7: 0.98, 8: 0.932, 9: 0.922},
    # Under 1.5
    "U15": {0: 1.983, 1: 1.373, 2: 1.06, 3: 0.952, 4: 0.913, 5: 0.891, 6: 0.904, 7: 0.856, 8: 0.936, 9: 1.0},
    # Over 3.5
    "O35": {0: 2.12, 1: 1.401, 2: 1.139, 3: 1.015, 4: 0.92, 5: 0.903, 6: 0.885, 7: 0.875, 8: 1.0, 9: 1.0},
    # Under 3.5
    "U35": {0: 1.0, 1: 1.0, 2: 1.361, 3: 1.206, 4: 1.115, 5: 1.063, 6: 0.992, 7: 0.954, 8: 0.926, 9: 0.917},
    # HT Casa
    "HT_H": {0: 1.539, 1: 1.372, 2: 1.193, 3: 1.04, 4: 1.022, 5: 1.019, 6: 0.941, 7: 1.145, 8: 1.0, 9: 1.0},
    # HT Pareggio
    "HT_D": {0: 1.0, 1: 1.0, 2: 0.825, 3: 0.961, 4: 0.893, 5: 0.877, 6: 0.821, 7: 0.686, 8: 1.0, 9: 1.0},
    # HT Trasferta
    "HT_A": {0: 1.167, 1: 1.171, 2: 1.049, 3: 1.001, 4: 0.932, 5: 0.966, 6: 1.295, 7: 1.0, 8: 1.0, 9: 1.0},
    # 1H Under 0.5
    "HT_U05": {0: 2.722, 1: 1.558, 2: 1.078, 3: 0.871, 4: 0.786, 5: 0.673, 6: 0.593, 7: 0.467, 8: 1.0, 9: 1.0},
}
            ...
            for s in day.get("slots", []):
                if s.get("result") != "PENDING" and s.get("fixture_id"):
                    ...
                    updates.append({
                        ...
                        # Include fixture_id so an upsert that falls back to INSERT
                        # (old signals never previously synced) doesn't violate the
                        # signal_history.fixture_id NOT NULL constraint.
                        "fixture_id": int(s["fixture_id"]),
                        "result": s.get("result"),
                        "pnl":    s.get("pnl", 0),
                        "goals_home": s.get("goals_home"),
                        "goals_away": s.get("goals_away"),
            ...
            for s in day.get("ml_slots", []):
                if s.get("result") != "PENDING" and s.get("fixture_id"):
                    ...
                    updates.append({
                        ...
                        # See note above: carry fixture_id for INSERT-fallback safety.
                        "fixture_id": int(s["fixture_id"]),
                        "result": s.get("result"),
                        "pnl":    s.get("pnl", 0),
                        "goals_home": s.get("goals_home"),
