...
# ---------------------------------------------------------------------------
#  TABELLA DI CALIBRAZIONE — Aggiornata il 2026-07-06 da update_poisson_calibration.py
#  Derivata da 67900 match storici
...
CALIBRATION_TABLE = {
    ...
    "H": {0: 0.394, 1: 0.778, 2: 1.071, 3: 1.024, 4: 1.029, 5: 0.999, 6: 1.005, 7: 1.068, 8: 1.068, 9: 1.0},
    # 1X2 Draw
    "D": {0: 0.2, 1: 0.906, 2: 0.927, 3: 0.971, 4: 1.14, 5: 0.964, 6: 1.0, 7: 1.0, 8: 1.0, 9: 1.0},
    # 1X2 Away
    "A": {0: 1.081, 1: 1.082, 2: 0.995, 3: 1.025, 4: 1.004, 5: 1.05, 6: 1.03, 7: 1.119, 8: 1.0, 9: 1.0},
    # Over 2.5
    "O25": {0: 3.0, 1: 1.905, 2: 1.255, 3: 1.205, 4: 1.094, 5: 1.013, 6: 0.969, 7: 0.924, 8: 0.939, 9: 0.973},
    # Under 2.5
    "U25": {0: 1.332, 1: 1.283, 2: 1.223, 3: 1.055, 4: 0.985, 5: 0.923, 6: 0.886, 7: 0.911, 8: 0.823, 9: 0.783},
    # BTTS Si
    "BTTS": {0: 1.0, 1: 2.074, 2: 1.368, 3: 1.14, 4: 1.045, 5: 0.96, 6: 0.874, 7: 0.841, 8: 0.831, 9: 1.0},
    # BTTS No
    "BTTS_NO": {0: 1.0, 1: 1.803, 2: 1.447, 3: 1.228, 4: 1.048, 5: 0.963, 6: 0.922, 7: 0.869, 8: 0.792, 9: 1.0},
    # 1H Over 0.5
    "HT05": {0: 1.0, 1: 1.0, 2: 2.544, 3: 1.869, 4: 1.376, 5: 1.187, 6: 1.066, 7: 0.981, 8: 0.89, 9: 0.879},
    # Over 1.5
    "O15": {0: 1.0, 1: 2.766, 2: 1.89, 3: 1.323, 4: 1.143, 5: 1.06, 6: 1.039, 7: 0.98, 8: 0.94, 9: 0.927},
    # Under 1.5
    "U15": {0: 1.918, 1: 1.329, 2: 1.062, 3: 0.926, 4: 0.924, 5: 0.878, 6: 0.822, 7: 0.699, 8: 0.653, 9: 1.0},
    # Over 3.5
    "O35": {0: 2.423, 1: 1.396, 2: 1.163, 3: 1.012, 4: 0.956, 5: 0.851, 6: 0.92, 7: 0.873, 8: 1.062, 9: 1.0},
    # Under 3.5
    "U35": {0: 1.0, 1: 0.68, 2: 1.378, 3: 1.139, 4: 1.178, 5: 1.035, 6: 0.993, 7: 0.946, 8: 0.927, 9: 0.897},
    # HT Casa
    "HT_H": {0: 1.146, 1: 1.248, 2: 1.152, 3: 1.038, 4: 0.989, 5: 0.968, 6: 1.117, 7: 1.17, 8: 1.0, 9: 1.0},
    # HT Pareggio
    "HT_D": {0: 1.0, 1: 1.0, 2: 0.912, 3: 0.955, 4: 0.905, 5: 0.875, 6: 0.714, 7: 0.748, 8: 1.0, 9: 1.0},
    # HT Trasferta
    "HT_A": {0: 1.22, 1: 1.182, 2: 1.068, 3: 1.038, 4: 1.023, 5: 1.08, 6: 1.273, 7: 1.0, 8: 1.0, 9: 1.0},
    # 1H Under 0.5
    "HT_U05": {0: 2.406, 1: 1.59, 2: 1.057, 3: 0.876, 4: 0.766, 5: 0.677, 6: 0.532, 7: 0.421, 8: 1.0, 9: 1.0},
}
