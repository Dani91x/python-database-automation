...
# ---------------------------------------------------------------------------
#  TABELLA DI CALIBRAZIONE — Aggiornata il 2026-05-11 da update_poisson_calibration.py
#  Derivata da 56083 match storici
...
CALIBRATION_TABLE = {
    ...
    "H": {0: 0.2, 1: 0.751, 2: 1.029, 3: 0.993, 4: 1.026, 5: 1.031, 6: 0.98, 7: 1.028, 8: 1.179, 9: 1.0},
    # 1X2 Draw
    "D": {0: 1.0, 1: 0.913, 2: 0.937, 3: 0.978, 4: 1.18, 5: 1.0, 6: 1.0, 7: 1.0, 8: 1.0, 9: 1.0},
    # 1X2 Away
    "A": {0: 1.076, 1: 1.073, 2: 1.01, 3: 1.002, 4: 1.034, 5: 1.089, 6: 1.041, 7: 1.089, 8: 1.0, 9: 1.0},
    # Over 2.5
    "O25": {0: 2.618, 1: 1.628, 2: 1.215, 3: 1.191, 4: 1.073, 5: 0.994, 6: 0.934, 7: 0.917, 8: 0.896, 9: 1.085},
    # Under 2.5
    "U25": {0: 0.2, 1: 1.511, 2: 1.236, 3: 1.119, 4: 1.007, 5: 0.941, 6: 0.894, 7: 0.925, 8: 0.876, 9: 0.872},
    # BTTS Si
    "BTTS": {0: 1.0, 1: 1.568, 2: 1.152, 3: 1.111, 4: 1.041, 5: 0.952, 6: 0.874, 7: 0.823, 8: 0.852, 9: 1.0},
    # BTTS No
    "BTTS_NO": {0: 1.0, 1: 1.703, 2: 1.497, 3: 1.224, 4: 1.058, 5: 0.966, 6: 0.937, 7: 0.946, 8: 0.886, 9: 1.0},
    # 1H Over 0.5
    "HT05": {0: 1.0, 1: 1.0, 2: 2.738, 3: 1.912, 4: 1.358, 5: 1.184, 6: 1.057, 7: 0.964, 8: 0.884, 9: 0.869},
    # Over 1.5
    "O15": {0: 1.0, 1: 1.0, 2: 1.859, 3: 1.151, 4: 1.082, 5: 1.049, 6: 1.029, 7: 0.974, 8: 0.931, 9: 0.936},
    # Under 1.5
    "U15": {0: 1.784, 1: 1.372, 2: 1.078, 3: 0.945, 4: 0.936, 5: 0.93, 6: 0.917, 7: 0.702, 8: 1.0, 9: 1.0},
    # Over 3.5
    "O35": {0: 1.874, 1: 1.38, 2: 1.097, 3: 0.986, 4: 0.893, 5: 0.85, 6: 0.846, 7: 0.811, 8: 1.0, 9: 1.0},
    # Under 3.5
    "U35": {0: 1.0, 1: 1.0, 2: 1.544, 3: 1.272, 4: 1.179, 5: 1.085, 6: 1.007, 7: 0.968, 8: 0.93, 9: 0.933},
    # HT Casa
    "HT_H": {0: 2.205, 1: 1.259, 2: 1.144, 3: 1.022, 4: 0.987, 5: 0.989, 6: 1.078, 7: 1.0, 8: 1.0, 9: 1.0},
    # HT Pareggio
    "HT_D": {0: 1.0, 1: 1.0, 2: 0.748, 3: 0.946, 4: 0.931, 5: 0.875, 6: 0.801, 7: 1.0, 8: 1.0, 9: 1.0},
    # HT Trasferta
    "HT_A": {0: 1.221, 1: 1.188, 2: 1.056, 3: 0.991, 4: 0.95, 5: 1.128, 6: 1.0, 7: 1.0, 8: 1.0, 9: 1.0},
    # 1H Under 0.5
    "HT_U05": {0: 2.495, 1: 1.622, 2: 1.106, 3: 0.893, 4: 0.77, 5: 0.693, 6: 0.513, 7: 0.347, 8: 1.0, 9: 1.0},
}
