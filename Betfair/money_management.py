...
# ---------------------------------------------------------------------------
#  TABELLA DI CALIBRAZIONE — Aggiornata il 2026-07-27 da update_poisson_calibration.py
#  Derivata da 70141 match storici
...
CALIBRATION_TABLE = {
    ...
    "H": {0: 0.891, 1: 0.975, 2: 1.064, 3: 1.009, 4: 1.023, 5: 0.996, 6: 1.014, 7: 1.055, 8: 0.984, 9: 1.0},
    # 1X2 Draw
    "D": {0: 0.2, 1: 0.932, 2: 0.953, 3: 0.969, 4: 1.099, 5: 1.047, 6: 1.0, 7: 1.0, 8: 1.0, 9: 1.0},
    # 1X2 Away
    "A": {0: 0.959, 1: 1.036, 2: 1.005, 3: 1.027, 4: 0.992, 5: 1.022, 6: 0.936, 7: 1.109, 8: 1.0, 9: 1.0},
    # Over 2.5
    "O25": {0: 3.0, 1: 1.818, 2: 1.254, 3: 1.226, 4: 1.08, 5: 1.012, 6: 0.954, 7: 0.918, 8: 0.926, 9: 1.033},
    # Under 2.5
    "U25": {0: 0.596, 1: 1.359, 2: 1.24, 3: 1.083, 4: 0.985, 5: 0.934, 6: 0.874, 7: 0.912, 8: 0.841, 9: 0.828},
    # BTTS Si
    "BTTS": {0: 1.0, 1: 1.784, 2: 1.345, 3: 1.13, 4: 1.057, 5: 0.953, 6: 0.873, 7: 0.812, 8: 0.83, 9: 1.0},
    # BTTS No
    "BTTS_NO": {0: 1.0, 1: 1.767, 2: 1.532, 3: 1.229, 4: 1.057, 5: 0.953, 6: 0.926, 7: 0.876, 8: 0.851, 9: 1.0},
    # 1H Over 0.5
    "HT05": {0: 1.0, 1: 1.0, 2: 2.386, 3: 1.844, 4: 1.377, 5: 1.183, 6: 1.066, 7: 0.979, 8: 0.888, 9: 0.859},
    # Over 1.5
    "O15": {0: 1.0, 1: 2.334, 2: 1.464, 3: 1.309, 4: 1.147, 5: 1.049, 6: 1.041, 7: 0.98, 8: 0.938, 9: 0.923},
    # Under 1.5
    "U15": {0: 1.973, 1: 1.34, 2: 1.06, 3: 0.922, 4: 0.938, 5: 0.876, 6: 0.825, 7: 0.837, 8: 0.72, 9: 1.0},
    # Over 3.5
    "O35": {0: 2.233, 1: 1.406, 2: 1.145, 3: 1.005, 4: 0.938, 5: 0.9, 6: 0.877, 7: 0.875, 8: 1.02, 9: 1.0},
    # Under 3.5
    "U35": {0: 1.0, 1: 0.892, 2: 1.357, 3: 1.22, 4: 1.119, 5: 1.05, 6: 0.997, 7: 0.952, 8: 0.925, 9: 0.91},
    # HT Casa
    "HT_H": {0: 1.66, 1: 1.408, 2: 1.171, 3: 1.041, 4: 0.986, 5: 0.98, 6: 1.034, 7: 1.126, 8: 1.0, 9: 1.0},
    # HT Pareggio
    "HT_D": {0: 1.0, 1: 1.0, 2: 0.86, 3: 0.965, 4: 0.892, 5: 0.885, 6: 0.734, 7: 0.714, 8: 1.0, 9: 1.0},
    # HT Trasferta
    "HT_A": {0: 1.116, 1: 1.174, 2: 1.061, 3: 1.032, 4: 0.961, 5: 1.028, 6: 1.183, 7: 1.0, 8: 1.0, 9: 1.0},
    # 1H Under 0.5
    "HT_U05": {0: 2.611, 1: 1.591, 2: 1.063, 3: 0.876, 4: 0.77, 5: 0.674, 6: 0.547, 7: 0.478, 8: 1.0, 9: 1.0},
}
