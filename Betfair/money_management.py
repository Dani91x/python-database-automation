...
# ---------------------------------------------------------------------------
#  TABELLA DI CALIBRAZIONE — Aggiornata il 2026-08-03 da update_poisson_calibration.py
#  Derivata da 71034 match storici
...
CALIBRATION_TABLE = {
    ...
    "H": {0: 1.527, 1: 0.913, 2: 1.049, 3: 1.008, 4: 1.005, 5: 0.974, 6: 1.04, 7: 1.03, 8: 1.022, 9: 1.0},
    # 1X2 Draw
    "D": {0: 0.2, 1: 0.949, 2: 0.944, 3: 0.987, 4: 1.196, 5: 1.265, 6: 1.0, 7: 1.0, 8: 1.0, 9: 1.0},
    # 1X2 Away
    "A": {0: 1.086, 1: 1.021, 2: 1.032, 3: 1.002, 4: 1.021, 5: 1.083, 6: 1.057, 7: 1.034, 8: 1.0, 9: 1.0},
    # Over 2.5
    "O25": {0: 2.657, 1: 1.585, 2: 1.244, 3: 1.23, 4: 1.088, 5: 1.003, 6: 0.958, 7: 0.888, 8: 0.909, 9: 0.951},
    # Under 2.5
    "U25": {0: 1.627, 1: 1.457, 2: 1.32, 3: 1.075, 4: 0.996, 5: 0.929, 6: 0.874, 7: 0.914, 8: 0.886, 9: 0.875},
    # BTTS Si
    "BTTS": {0: 1.0, 1: 1.594, 2: 1.168, 3: 1.144, 4: 1.062, 5: 0.953, 6: 0.87, 7: 0.778, 8: 0.875, 9: 1.0},
    # BTTS No
    "BTTS_NO": {0: 1.0, 1: 1.593, 2: 1.624, 3: 1.236, 4: 1.057, 5: 0.948, 6: 0.92, 7: 0.937, 8: 0.891, 9: 1.0},
    # 1H Over 0.5
    "HT05": {0: 1.0, 1: 1.0, 2: 2.761, 3: 1.8, 4: 1.394, 5: 1.183, 6: 1.061, 7: 0.983, 8: 0.889, 9: 0.856},
    # Over 1.5
    "O15": {0: 1.0, 1: 1.0, 2: 1.303, 3: 1.244, 4: 1.135, 5: 1.044, 6: 1.044, 7: 0.976, 8: 0.933, 9: 0.909},
    # Under 1.5
    "U15": {0: 2.143, 1: 1.369, 2: 1.075, 3: 0.915, 4: 0.945, 5: 0.885, 6: 0.865, 7: 0.897, 8: 1.0, 9: 1.0},
    # Over 3.5
    "O35": {0: 2.061, 1: 1.356, 2: 1.152, 3: 1.018, 4: 0.953, 5: 0.865, 6: 0.854, 7: 0.849, 8: 0.899, 9: 1.0},
    # Under 3.5
    "U35": {0: 1.0, 1: 1.585, 2: 1.43, 3: 1.26, 4: 1.162, 5: 1.037, 6: 0.991, 7: 0.949, 8: 0.935, 9: 0.922},
    # HT Casa
    "HT_H": {0: 1.681, 1: 1.314, 2: 1.172, 3: 1.009, 4: 1.003, 5: 1.023, 6: 1.047, 7: 1.191, 8: 1.0, 9: 1.0},
    # HT Pareggio
    "HT_D": {0: 1.0, 1: 1.0, 2: 0.989, 3: 0.932, 4: 0.914, 5: 0.869, 6: 0.696, 7: 0.815, 8: 1.0, 9: 1.0},
    # HT Trasferta
    "HT_A": {0: 1.268, 1: 1.199, 2: 1.055, 3: 1.033, 4: 1.017, 5: 1.019, 6: 0.972, 7: 1.0, 8: 1.0, 9: 1.0},
    # 1H Under 0.5
    "HT_U05": {0: 2.647, 1: 1.588, 2: 1.05, 3: 0.885, 4: 0.77, 5: 0.664, 6: 0.574, 7: 0.347, 8: 1.0, 9: 1.0},
}
