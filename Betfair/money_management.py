...
# ---------------------------------------------------------------------------
#  TABELLA DI CALIBRAZIONE — Aggiornata il 2026-09-15 da update_poisson_calibration.py
#  Derivata da 76587 match storici
...
CALIBRATION_TABLE = {
    ...
    "H": {0: 1.206, 1: 0.912, 2: 1.107, 3: 1.044, 4: 1.022, 5: 1.012, 6: 1.003, 7: 1.047, 8: 0.995, 9: 1.0},
    # 1X2 Draw
    "D": {0: 0.679, 1: 0.934, 2: 0.92, 3: 0.952, 4: 1.011, 5: 0.679, 6: 1.0, 7: 1.0, 8: 1.0, 9: 1.0},
    # 1X2 Away
    "A": {0: 1.205, 1: 1.029, 2: 1.048, 3: 0.992, 4: 1.002, 5: 1.054, 6: 1.045, 7: 1.046, 8: 1.0, 9: 1.0},
    # Over 2.5
    "O25": {0: 3.0, 1: 1.76, 2: 1.265, 3: 1.23, 4: 1.077, 5: 1.012, 6: 0.956, 7: 0.929, 8: 0.919, 9: 0.945},
    # Under 2.5
    "U25": {0: 1.685, 1: 1.413, 2: 1.204, 3: 1.079, 4: 0.986, 5: 0.937, 6: 0.873, 7: 0.907, 8: 0.851, 9: 0.75},
    # BTTS Si
    "BTTS": {0: 1.0, 1: 2.484, 2: 1.296, 3: 1.169, 4: 1.049, 5: 0.958, 6: 0.871, 7: 0.821, 8: 0.908, 9: 1.0},
    # BTTS No
    "BTTS_NO": {0: 1.0, 1: 1.441, 2: 1.506, 3: 1.234, 4: 1.051, 5: 0.959, 6: 0.905, 7: 0.895, 8: 0.708, 9: 1.0},
    # 1H Over 0.5
    "HT05": {0: 1.0, 1: 1.0, 2: 2.663, 3: 1.802, 4: 1.37, 5: 1.157, 6: 1.056, 7: 0.982, 8: 0.901, 9: 0.852},
    # Over 1.5
    "O15": {0: 1.0, 1: 1.0, 2: 1.708, 3: 1.518, 4: 1.149, 5: 1.092, 6: 1.042, 7: 0.979, 8: 0.943, 9: 0.942},
    # Under 1.5
    "U15": {0: 1.745, 1: 1.314, 2: 1.063, 3: 0.919, 4: 0.884, 5: 0.873, 6: 0.711, 7: 0.75, 8: 1.0, 9: 1.0},
    # Over 3.5
    "O35": {0: 2.191, 1: 1.412, 2: 1.15, 3: 1.005, 4: 0.936, 5: 0.898, 6: 0.889, 7: 0.933, 8: 0.93, 9: 1.0},
    # Under 3.5
    "U35": {0: 1.0, 1: 1.37, 2: 1.193, 3: 1.195, 4: 1.121, 5: 1.051, 6: 0.997, 7: 0.95, 8: 0.924, 9: 0.913},
    # HT Casa
    "HT_H": {0: 1.609, 1: 1.301, 2: 1.175, 3: 1.04, 4: 0.995, 5: 0.975, 6: 1.111, 7: 1.188, 8: 1.0, 9: 1.0},
    # HT Pareggio
    "HT_D": {0: 1.0, 1: 1.0, 2: 0.833, 3: 0.943, 4: 0.917, 5: 0.874, 6: 0.779, 7: 0.698, 8: 1.0, 9: 1.0},
    # HT Trasferta
    "HT_A": {0: 1.457, 1: 1.187, 2: 1.045, 3: 0.994, 4: 0.947, 5: 0.943, 6: 0.889, 7: 1.0, 8: 1.0, 9: 1.0},
    # 1H Under 0.5
    "HT_U05": {0: 2.679, 1: 1.523, 2: 1.053, 3: 0.895, 4: 0.803, 5: 0.682, 6: 0.563, 7: 0.375, 8: 1.0, 9: 1.0},
}
