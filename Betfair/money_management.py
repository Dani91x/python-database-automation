...
# ---------------------------------------------------------------------------
#  TABELLA DI CALIBRAZIONE — Aggiornata il 2026-05-04 da update_poisson_calibration.py
#  Derivata da 52845 match storici
...
CALIBRATION_TABLE = {
    ...
    "H": {0: 0.592, 1: 0.818, 2: 1.061, 3: 0.985, 4: 1.044, 5: 1.044, 6: 1.012, 7: 1.079, 8: 1.173, 9: 1.0},
    # 1X2 Draw
    "D": {0: 1.0, 1: 0.881, 2: 0.956, 3: 0.942, 4: 1.059, 5: 1.0, 6: 1.0, 7: 1.0, 8: 1.0, 9: 1.0},
    # 1X2 Away
    "A": {0: 0.986, 1: 0.992, 2: 0.994, 3: 1.023, 4: 1.003, 5: 1.043, 6: 1.104, 7: 1.024, 8: 1.0, 9: 1.0},
    # Over 2.5
    "O25": {0: 2.304, 1: 1.643, 2: 1.27, 3: 1.207, 4: 1.055, 5: 0.972, 6: 0.926, 7: 0.932, 8: 0.921, 9: 1.0},
    # Under 2.5
    "U25": {0: 1.0, 1: 1.395, 2: 1.192, 3: 1.134, 4: 1.036, 5: 0.955, 6: 0.886, 7: 0.906, 8: 0.873, 9: 0.894},
    # BTTS Si
    "BTTS": {0: 1.0, 1: 1.51, 2: 1.251, 3: 1.144, 4: 1.038, 5: 0.937, 6: 0.877, 7: 0.808, 8: 0.884, 9: 1.0},
    # BTTS No
    "BTTS_NO": {0: 1.0, 1: 1.536, 2: 1.536, 3: 1.22, 4: 1.077, 5: 0.97, 6: 0.918, 7: 0.911, 8: 0.899, 9: 1.0},
    # 1H Over 0.5
    "HT05": {0: 1.0, 1: 1.0, 2: 2.571, 3: 1.628, 4: 1.433, 5: 1.177, 6: 1.053, 7: 0.955, 8: 0.875, 9: 0.849},
    # Over 1.5
    "O15": {0: 1.0, 1: 1.0, 2: 1.785, 3: 1.177, 4: 1.113, 5: 1.091, 6: 1.035, 7: 0.952, 8: 0.925, 9: 0.945},
    # Under 1.5
    "U15": {0: 1.667, 1: 1.4, 2: 1.147, 3: 0.933, 4: 0.884, 5: 0.902, 6: 0.9, 7: 0.72, 8: 1.0, 9: 1.0},
    # Over 3.5
    "O35": {0: 1.93, 1: 1.356, 2: 1.106, 3: 0.96, 4: 0.885, 5: 0.863, 6: 0.908, 7: 0.788, 8: 1.0, 9: 1.0},
    # Under 3.5
    "U35": {0: 1.0, 1: 1.0, 2: 1.573, 3: 1.164, 4: 1.162, 5: 1.091, 6: 1.021, 7: 0.965, 8: 0.934, 9: 0.928},
    # HT Casa
    "HT_H": {0: 1.395, 1: 1.369, 2: 1.138, 3: 1.051, 4: 1.028, 5: 0.975, 6: 1.223, 7: 1.0, 8: 1.0, 9: 1.0},
    # HT Pareggio
    "HT_D": {0: 1.0, 1: 1.0, 2: 0.676, 3: 0.94, 4: 0.931, 5: 0.884, 6: 0.927, 7: 1.0, 8: 1.0, 9: 1.0},
    # HT Trasferta
    "HT_A": {0: 0.964, 1: 1.143, 2: 1.024, 3: 0.975, 4: 0.929, 5: 1.092, 6: 1.0, 7: 1.0, 8: 1.0, 9: 1.0},
    # 1H Under 0.5
    "HT_U05": {0: 2.766, 1: 1.661, 2: 1.134, 3: 0.901, 4: 0.777, 5: 0.628, 6: 0.658, 7: 0.408, 8: 1.0, 9: 1.0},
}
