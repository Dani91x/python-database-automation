...
# ---------------------------------------------------------------------------
# ATLANTE HAZARD — vive in ``hazard_atlas`` (modulo PURO, senza flumine)
# ---------------------------------------------------------------------------
# 17/09/2026: stava qui, e caricarlo da safe_strategy/service.py importava
# questo modulo -> ``from flumine import BaseStrategy`` -> flumine sostituiva
# ``RunnerBookEX`` per TUTTO il processo del feed e ogni prezzo diventava None.
# I nomi restano esposti da qui per i chiamanti storici.
from .hazard_atlas import (  # noqa: F401
    ATLAS_DEFAULT_PATH,
    hazard_bucket,
    hazard_goals_key,
    hazard_lookup,
