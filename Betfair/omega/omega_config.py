...
_SPEC: dict[str, tuple[Any, Callable[[Any], Any], float | None, float | None]] = {
    ...
    # O1 (25/09, ACCESO di default: ordine dell'utente "per TUTTI i bot i valori
    # statistici e gli aiuti di default accesi"): True = nella catena dei lambda pre-match le
    ...
    # False = catena di sempre (fixture prima).
    ...
    # O5 (25/09, ACCESO di default: ordine dell'utente sugli aiuti statistici
    # accesi): True = i CARTELLINI ROSSI del feed entrano
    ...
    # campione: AUDIT_2026-09-25/MISURA_PUNTO8_2026-09-25.md sez. 2. False =
    # modello di sempre (rossi ignorati).
